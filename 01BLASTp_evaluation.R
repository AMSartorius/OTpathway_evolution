...
library(writexl)    # for exporting as excel file
library(tidyverse)  # for function "first"
# library(knitr) # in case you experience trouble loading the data, you might need to uncomment and use this package
...
for (i in 4:10) {
  OTpthwy.ress$age.3.levels.vert[OTpthwy.ress$Phylostratum == i] <- "medium.aged"
}
for (i in 11:20) {
  OTpthwy.ress$age.3.levels.vert[OTpthwy.ress$Phylostratum == i] <- "modern"
}
