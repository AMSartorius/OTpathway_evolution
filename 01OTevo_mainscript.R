...
## =================================  BLASTp/microsynteny analyses

# refer to R script "02BLASTp_evaluation.R"
...
# save plot
# ggsave(filename = output/dndsOT_tree_mq_phylo6.pdf", dnds_OT_tree_mq,
#        width = 20, height = 8, units = "in", device='pdf')
...
# refer to R script "03FUMA_results_updated.R"
...
# Run/use script '04abagen_analyses_updated.ipynb' for the analyses. 
 

# IMPORTANT: Previous installation and set up strictly necessary!!! 
# To start jupyter lab, open command line/bash and enter "jupyter lab" or "jupyter-lab", then it will open
...
# refer to R script "05Abagen_DK_atlas_expression_analyses02.R"
...
DSabagen      <- read_csv("output/abagen_dk/DS_values_abagen.csv")   # each row corresponds to a gene column from the expression matrix, i.e., rows are genes here
gnames        <- read_csv("output/abagen_dk/AHBAdk_220513_9861.csv")
