...
rowMeans(jt[2:17])
1.654056 - ((1.516789+ 1.501140+ 1.516126 +1.456094)/4) 
################
...
# further analyses. Skip commented part below (do not pass Go. Do not collect $200) and directly proceed with "Plot Phylostratum Enrichment" section of *this* script.
