...
# IMPORTANT !!! The package has to be downloaded from the archive: https://cran.r-project.org/src/contrib/Archive/powerAnalysis/, version 0.2.1
...
# ...... for supplementary materials
write_xlsx(test.stats.dk2.desc, "output/supp_mat_new/supp_mat_11.xlsx")
